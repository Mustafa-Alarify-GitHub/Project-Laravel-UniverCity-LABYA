    ...
    <div class="div_books">
        <div class="fliter_catogry">
            ...
            <div class="list_catogries">
                @foreach ($data as $i)
                    <a href={{ route('show.subject', $i->id) }}>
                        <h4 id="name_cat">{{ $i->name }}</h4>
                    </a>
                @endforeach
        ...
        <div class="table_books">
            <div class="table_books_head">
                ...
                <h2 style="width: 40%">فتح الكتاب</h2>
            ...
            @foreach ($subj as $sb)
                <div class="table_books_body">
                    ...
                    <div style="display: flex ;width: 40%;justify-content: space-around">
                        ...
                        <form action={{ route('delete.subject', ['id'=>$sb->id]) }} method="post">
                            @csrf
                            @method('DELETE')
                            <button type="submit" id="btn_delete_cat"><img src="image/icon_delete.png"
                                    alt=""></button>
                        </form>
                    </div>
                </div>
